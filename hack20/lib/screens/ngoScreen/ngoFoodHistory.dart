    ...
    return Container(
      ...
      child: StreamBuilder<UserProfile>(
          ...
          builder: (context, profSnap) {
            ...
            if (profSnap.data.userName == '') return displayAddData('Profile');
            return StreamBuilder(
                stream: DatabaseService(ngoName: profSnap.data.userName).ngoFoodHistory,
                    ...
                    return ListView(
                      children: <Widget>[
                        Padding(
                            ...
                            child: Text('NGO History', style: TextStyle(fontSize: 25, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 3))
                        ),
                        SizedBox(height: 5),
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: <Widget>[
                                                                        ...
                                                                        SizedBox(height: 5),
                                                                        Text('Picked up on ${getDateAndTime(ngoFood[index].notifiedTime)}', style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w400)),
                                                                      ],
                                                                    ),
                                                                  )
                                                              ),
