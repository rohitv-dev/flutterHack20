              ...
              return StreamBuilder<UserNGOAddress>(
                  ...
                  builder: (context, adSnap) {
                    if (adSnap.hasData) {
                      ...
                      if (addressData.latitude == 0.0) return displayAddData('Address');
                                      ...
                                      return ListView(
                                        children: <Widget>[
                                          ...
                                          Padding(
                                              ...
                                              child: Text('Food Available To Be Picked Up', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white))
                                          ),
                                          SizedBox(height: 5),
                                          ListView.builder(
                                            shrinkWrap: true,
